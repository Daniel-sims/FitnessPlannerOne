package com.danielsims.testapp.fitnessplanner.RecyclerView;
...
import com.danielsims.testapp.fitnessplanner.RecyclerView.Listeners.BaseRecyclerListener;
import com.danielsims.testapp.fitnessplanner.RecyclerView.ViewHolders.BaseViewHolder;

import java.util.ArrayList;
import java.util.List;

/*
    Implementation sourced from; https://medium.com/@leonidustenko/generic-recyclerview-adapter-a69a24ec25bc
 */
 ...
 * @param <L>  click listener {@link BaseRecyclerViewAdapter.BaseRecyclerListener}
...
public abstract class GenericRecyclerAdapter<T, L extends BaseRecyclerListener, VH extends BaseViewHolder<T, L>> extends RecyclerView.Adapter<VH> {
    ...
    /**
     * Set click listener, which must extend {@link BaseRecyclerViewAdapter.BaseRecyclerListener}
     *
